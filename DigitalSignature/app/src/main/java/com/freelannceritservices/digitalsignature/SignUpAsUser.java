    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String id = FirebaseFirestore.getInstance().collection("User").document().getId();
                FirebaseFirestore.getInstance().collection("User").whereEqualTo("name", name).whereEqualTo("password", pass).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if (pass.equalsIgnoreCase(pass1)) {
                                    if (name.equalsIgnoreCase(name1)) {
                                        ...
                                        prefsEditor.commit();
                                        check = false;
                                        Intent i = new Intent(SignUpAsUser.this, MainActivity.class);
                                ...
                                Toast.makeText(SignUpAsUser.this, "User Not Found", Toast.LENGTH_SHORT).show();
                            }

                        } else {
                            Toast.makeText(SignUpAsUser.this, "" + task.getException(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
...
//                        }
//                        else{
//                            Toast.makeText(SignUpAsUser.this, ""+string1, Toast.LENGTH_SHORT).show();
//                        }
...
//                            int RC;
//
//                            url = new URL("https://192.168.137.1/aman/loginasuser.php");
